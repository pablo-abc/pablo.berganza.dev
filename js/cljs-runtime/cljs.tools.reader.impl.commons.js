...
var G__30209 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__30209;
continue;
} else {
return ch;
...
var vec__30147 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30147,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq30177){
...
return (function() { 
var G__30274__delegate = function (rdr,_){
...
var G__30274 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__30275__i = 0, G__30275__a = new Array(arguments.length -  1);
while (G__30275__i < G__30275__a.length) {G__30275__a[G__30275__i] = arguments[G__30275__i + 1]; ++G__30275__i;}
  _ = new cljs.core.IndexedSeq(G__30275__a,0,null);
} 
return G__30274__delegate.call(this,rdr,_);};
G__30274.cljs$lang$maxFixedArity = 1;
G__30274.cljs$lang$applyTo = (function (arglist__30276){
var rdr = cljs.core.first(arglist__30276);
var _ = cljs.core.rest(arglist__30276);
return G__30274__delegate(rdr,_);
});
