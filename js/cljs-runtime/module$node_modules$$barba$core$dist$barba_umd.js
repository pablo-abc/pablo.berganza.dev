...
shadow$provide.module$node_modules$$barba$core$dist$barba_umd=function(global,require,module,exports){!function(n,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t():"function"==typeof define&&define.amd?define(t):n.barba=t()}(this,function(){function t$jscomp$2(r,i,e){if(!r.s){if(e instanceof n$jscomp$5){if(!e.s)return void(e.o=t$jscomp$2.bind(null,r,i));1&i&&(i=e.s);e=e.v}if(e&&e.then)return void e.then(t$jscomp$2.bind(null,r,i),t$jscomp$2.bind(null,r,2));r.s=i;r.v=e;(i=r.o)&&
i(r)}}function r$jscomp$2(n,t){try{var r=n()}catch(n$2){return t(n$2)}return r&&r.then?r.then(void 0,t):r}function p(n,t){var r,i=[],e=0,o=0,u="",f=t&&t.delimiter||l;t=t&&t.whitelist||void 0;for(var s=!1;null!==(r=d.exec(n));){var a=r[0],h=r[1],v=r.index;if(u+=n.slice(o,v),o=v+a.length,h)u+=h[1],s=!0;else{a="";h=r[2];v=r[3];var P=r[4];r=r[5];if(!s&&u.length){var E=u.length-1,x=u[E];(!t||-1<t.indexOf(x))&&(a=x,u=u.slice(0,E))}u&&(i.push(u),u="",s=!1);v=v||P;P=a||f;i.push({name:h||e++,prefix:a,delimiter:P,
optional:"?"===r||"*"===r,repeat:"+"===r||"*"===r,pattern:v?v.replace(/([=!:$\/()])/g,"\\$1"):"[^"+m(P===f?P:P+f)+"]+?"})}}return(u||o<n.length)&&i.push(u+n.substr(o)),i}function w(n){for(var t=Array(n.length),r$jscomp$0=0;r$jscomp$0<n.length;r$jscomp$0++)"object"==typeof n[r$jscomp$0]&&(t[r$jscomp$0]=new RegExp("^(?:"+n[r$jscomp$0].pattern+")$"));return function(r,i){var e="";i=i&&i.encode||encodeURIComponent;for(var u=0;u<n.length;u++){var f=n[u];if("string"!=typeof f){var c,s=r?r[f.name]:void 0;
if(Array.isArray(s)){if(!f.repeat)throw new TypeError('Expected "'+f.name+'" to not repeat, but got array');if(0===s.length){if(f.optional)continue;throw new TypeError('Expected "'+f.name+'" to not be empty');}for(var a=0;a<s.length;a++){if(c=i(s[a],f),!t[u].test(c))throw new TypeError('Expected all "'+f.name+'" to match "'+f.pattern+'"');e+=(0===a?f.prefix:f.delimiter)+c}}else if("string"!=typeof s&&"number"!=typeof s&&"boolean"!=typeof s){if(!f.optional)throw new TypeError('Expected "'+f.name+'" to be '+
(f.repeat?"an array":"a string"));}else{if(c=i(String(s),f),!t[u].test(c))throw new TypeError('Expected "'+f.name+'" to match "'+f.pattern+'", but got "'+c+'"');e+=f.prefix+c}}else e+=f}return e}}function m(n){return n.replace(/([.+*?=^!:${}()[\]|\/\\])/g,"\\$1")}function P(n,t,r){var i=(r=r||{}).strict,e=!1!==r.start,o=!1!==r.end,u=r.delimiter||l,f=[].concat(r.endsWith||[]).map(m).concat("$").join("|");e=e?"^":"";for(var s=0;s<n.length;s++){var a=n[s];if("string"==typeof a)e+=m(a);else{var h=a.repeat?
"(?:"+a.pattern+")(?:"+m(a.delimiter)+"(?:"+a.pattern+"))*":a.pattern;t&&t.push(a);e+=a.optional?a.prefix?"(?:"+m(a.prefix)+"("+h+"))?":"("+h+")?":m(a.prefix)+"("+h+")"}}o?(i||(e+="(?:"+m(u)+")?"),e+="$"===f?"$":"(?\x3d"+f+")"):(n=n[n.length-1],n="string"==typeof n?n[n.length-1]===u:void 0===n,i||(e+="(?:"+m(u)+"(?\x3d"+f+"))?"),n||(e+="(?\x3d"+m(u)+"|"+f+")"));return new RegExp(e,r&&r.sensitive?"":"i")}function q(n$jscomp$1,t$jscomp$1,r$jscomp$0){return void 0===t$jscomp$1&&(t$jscomp$1=2E3),function(n$jscomp$0,
t$jscomp$0,r,i){return new Promise(function(e,o){var u=window.setTimeout(function(){var t=Error("Timeout error");i(n$jscomp$0,t);o(t)},t$jscomp$0);r.then(function(n){window.clearTimeout(u);e(n)},function(t){window.clearTimeout(u);i(n$jscomp$0,t);o(t)}).catch(function(n){o(n)})})}(n$jscomp$1,t$jscomp$1,U(n$jscomp$1),r$jscomp$0)}var n$jscomp$5=function(){function n$jscomp$0(){}return n$jscomp$0.prototype.then=function(r,i){var e=new n$jscomp$0,o$jscomp$0=this.s;if(o$jscomp$0){if(o$jscomp$0=1&o$jscomp$0?
r:i){try{t$jscomp$2(e,1,o$jscomp$0(this.v))}catch(n$0){t$jscomp$2(e,2,n$0)}return e}return this}return this.o=function(n){try{var o=n.v;1&n.s?t$jscomp$2(e,1,r?r(o):o):i?t$jscomp$2(e,1,i(o)):t$jscomp$2(e,2,o)}catch(n$1){t$jscomp$2(e,2,n$1)}},e},n$jscomp$0}(),i$jscomp$4;$jscomp.initSymbol();$jscomp.initSymbolAsyncIterator();$jscomp.initSymbol();$jscomp.initSymbolAsyncIterator();$jscomp.initSymbol();Symbol.asyncIterator||(Symbol.asyncIterator=Symbol("Symbol.asyncIterator"));!0;(function(n){n[n.off=0]=
"off";n[n.error=1]="error";n[n.warning=2]="warning";n[n.info=3]="info";n[n.debug=4]="debug"})(i$jscomp$4||(i$jscomp$4={}));var o=i$jscomp$4.off,u=function(n){this.m=n};u.getLevel=function(){return o};u.setLevel=function(n){return o=i$jscomp$4[n]};u.prototype.error=function(){for(var n=[],t=arguments.length;t--;)n[t]=arguments[t];this.P(console.error,i$jscomp$4.error,n)};u.prototype.warn=function(){for(var n=[],t=arguments.length;t--;)n[t]=arguments[t];this.P(console.warn,i$jscomp$4.warning,n)};u.prototype.info=
